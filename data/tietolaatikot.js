// ============ TIETOLAATIKOT ============
// Rakenne ja perustelut: ks. TIETOLAATIKKO_UI_SIJOITTELU.md ja TIETOLAATIKKO_SISALLOT.md (repon juuressa).
//
// Tämä tiedosto ladataan tällä hetkellä klassisena <script>-tagina sekä game/yhteiskunta.html:ään
// että viitteellisesti game/yhteiskunta.jsx:ään (globaali muuttuja TIETOLAATIKOT), koska projektissa
// ei vielä ole bundlaajaa. KEHITYSSUUNNITELMA_2026-07.md:n viikko 1 tiistain Vite-migraatio muuttaa
// tämän myöhemmin ES-moduuliksi (export const) — silloin tämä tiedosto ja sen <script>-viittaukset
// päivitetään import/export-muotoon samalla kertaa, ei aiemmin (ettei rikota nyt toimivaa html-versiota).
//
// Kentät (ks. TIETOLAATIKKO_UI_SIJOITTELU.md kohta 2):
//   id             uniikki, ei muutu enää julkaisun jälkeen
//   kategoria      yksi kuudesta: vaesto | talous | yhteiskunta | ymparisto | koulutus | historia
//   aikakausiehto  pienin era-indeksi (0=Muinaisaika ... 4=Moderni) jolloin laatikko on relevantti
//   prioriteetti   "korkea" | "normaali" — vain "korkea" saa kontekstuaalisen ℹ️-kuvakkeen paneelin lisäksi
//   kontekstuaalinen  näytetäänkö inline-ikonina olemassa olevassa/suunnitellussa UI-kohdassa
//   otsikko/sisalto   kielikohtaiset tekstit ({ fi, en, da }). Uusilla (14-26) toistaiseksi vain fi
//                     (sama rajaus kuin muualla pelissä, esim. sivilisaatiokohtaiset aikakausinimet).
var TIETOLAATIKOT = [
  // ===== Osa A: 13 olemassa olevaa (siirretty koodista sellaisenaan 13.7., ei sisältömuutoksia) =====
  {
    id: "elinajanodote", kategoria: "vaesto", aikakausiehto: 0, prioriteetti: "normaali", kontekstuaalinen: true,
    otsikko: { fi: "Elinajanodote", en: "Life Expectancy", da: "Middellevetid" },
    sisalto: {
  ...
  {
    id: "tyollisyysaste", kategoria: "talous", aikakausiehto: 2, prioriteetti: "normaali", kontekstuaalinen: true,
    otsikko: { fi: "Työllisyysaste", en: "Employment Rate", da: "Beskæftigelsesgrad" },
    sisalto: {
  ...
  {
    id: "saasteindeksi", kategoria: "ymparisto", aikakausiehto: 2, prioriteetti: "normaali", kontekstuaalinen: true,
    otsikko: { fi: "Saasteindeksi", en: "Pollution Index", da: "Forureningsindeks" },
    sisalto: {
  ...
  {
    id: "bkt_per_asukas", kategoria: "talous", aikakausiehto: 3, prioriteetti: "normaali", kontekstuaalinen: true,
    otsikko: { fi: "Bruttokansantuote per asukas", en: "Gross Domestic Product per capita", da: "Bruttonationalprodukt per indbygger" },
    sisalto: {
  ...
  {
    id: "rikollisuusaste", kategoria: "yhteiskunta", aikakausiehto: 3, prioriteetti: "normaali", kontekstuaalinen: true,
    otsikko: { fi: "Rikollisuusaste", en: "Crime Rate", da: "Kriminalitetsrate" },
    sisalto: {
  ...
  {
    id: "onnellisuusindeksi", kategoria: "yhteiskunta", aikakausiehto: 4, prioriteetti: "normaali", kontekstuaalinen: true,
    otsikko: { fi: "Onnellisuusindeksi", en: "Happiness Index", da: "Lykkeindeks" },
    sisalto: {
  ...
  {
    id: "maatalousmoodi", kategoria: "talous", aikakausiehto: 0, prioriteetti: "normaali", kontekstuaalinen: true,
    otsikko: { fi: "Maatalouden suuntaus", en: "Agricultural focus", da: "Landbrugsretning" },
    sisalto: {
  ...
  {
    id: "terveyspainotus", kategoria: "vaesto", aikakausiehto: 0, prioriteetti: "normaali", kontekstuaalinen: true,
    otsikko: { fi: "Ehkäisevä vs sairaalapainotteinen hoito", en: "Preventive vs. hospital-focused care", da: "Forebyggende vs. hospitalsorienteret pleje" },
    sisalto: {
  ...
  {
    id: "erikoislaakarit", kategoria: "vaesto", aikakausiehto: 3, prioriteetti: "normaali", kontekstuaalinen: true,
    otsikko: { fi: "Erikoislääkärien osuus", en: "Share of specialists", da: "Andel speciallæger" },
    sisalto: {
  ...
  {
    id: "tutkimussuuntaus", kategoria: "koulutus", aikakausiehto: 2, prioriteetti: "normaali", kontekstuaalinen: true,
    otsikko: { fi: "Perustutkimus vs soveltava tutkimus", en: "Basic vs. applied research", da: "Grundforskning vs. anvendt forskning" },
    sisalto: {
  ...
  {
    id: "opetussuuntaus", kategoria: "koulutus", aikakausiehto: 0, prioriteetti: "normaali", kontekstuaalinen: true,
    otsikko: { fi: "Opetuksen suuntaus", en: "Education focus", da: "Uddannelsesretning" },
    sisalto: {
  ...
  {
    id: "rikostutkijat", kategoria: "yhteiskunta", aikakausiehto: 3, prioriteetti: "normaali", kontekstuaalinen: true,
    otsikko: { fi: "Rikostutkijat", en: "Detectives", da: "Detektiver" },
    sisalto: {
  ...
  {
    id: "teollisuussuuntaus", kategoria: "talous", aikakausiehto: 2, prioriteetti: "normaali", kontekstuaalinen: true,
    otsikko: { fi: "Perustuotanto vs erikoistunut teollisuus", en: "Basic production vs. specialized industry", da: "Basisproduktion vs. specialiseret industri" },
    sisalto: {
  ...
  // ===== Osa B: 13 uutta (luonnos hyväksytty 10.7., toistaiseksi vain fi — ks. TIETOLAATIKKO_SISALLOT.md) =====
  // Viikko 1 to 16.7.: 5 korkean prioriteetin, kontekstuaalinen: true
  {
    id: "huoltosuhde", kategoria: "vaesto", aikakausiehto: 0, prioriteetti: "korkea", kontekstuaalinen: true,
    otsikko: { fi: "Huoltosuhde" },
    sisalto: { fi: "Huoltosuhde kertoo, montako lasta ja vanhusta on sataa työikäistä kohden — se on keskeinen mittari sille, kuinka paljon työikäinen väestö joutuu elättämään muita. Suomessa huoltosuhde on yksi Euroopan heikoimmista väestön ikääntymisen vuoksi. Pelissä huoltosuhde lasketaan lasten ja vanhusten yhteismäärästä suhteessa työikäisiin, ja se näkyy väestöpyramidin yhteydessä." },
  },
  {
    id: "demografinen_siirtyma", kategoria: "historia", aikakausiehto: 0, prioriteetti: "korkea", kontekstuaalinen: true,
    otsikko: { fi: "Demografinen siirtymä" },
    sisalto: { fi: "Demografinen siirtymä tarkoittaa, että yhteiskunnan kehittyessä ensin kuolleisuus laskee (parempi ravinto, hygienia, lääketiede) ja vasta myöhemmin syntyvyys — välivaiheessa väestö kasvaa nopeasti, koska syntyvyys on yhä korkea mutta yhä harvempi kuolee lapsena. Suomessa tämä tapahtui 1800–1900-luvuilla. Pelissä sama ilmiö näkyy syntyvyyskertoimen hitaana laskuna aikakausittain (TFR5 0,9 → 0,5, −44 %), samalla kun lapsikuolleisuus laskee huomattavasti nopeammin (0,17 → 0,008, −95 %)." },
  },
  {
    id: "hallintomuodot_legitimiteetti", kategoria: "yhteiskunta", aikakausiehto: 0, prioriteetti: "korkea", kontekstuaalinen: true,
    otsikko: { fi: "Hallintomuodot ja legitimiteetti" },
    sisalto: { fi: "Politiikan tutkimuksessa legitimiteetti tarkoittaa sitä, missä määrin kansa hyväksyy vallanpitäjän oikeuden hallita — se voi perustua perinteeseen (esim. heimoneuvosto), karismaan tai lakiin/menettelyihin (esim. vaalit). Sosiologi Max Weber erotti nämä kolme legitimiteetin tyyppiä 1900-luvun alussa. Pelissä hallintomuodon kertoimet mallintavat karkeasti tätä: itsevaltaiset hallinnot ovat tehokkaita mutta hauraita, kun taas demokratia on hitaampi mutta vakaampi." },
  },
  {
    id: "ruokaturva_nalanhata", kategoria: "talous", aikakausiehto: 0, prioriteetti: "korkea", kontekstuaalinen: true,
    otsikko: { fi: "Ruokaturva ja nälänhätä" },
    sisalto: { fi: "Ruokaturva tarkoittaa sitä, että kaikilla on jatkuvasti riittävästi ravitsevaa ruokaa. Esiteollisissa yhteiskunnissa yksikin huono satovuosi saattoi tarkoittaa nälänhätää — Suomen nälkävuosina 1866–1868 kuoli arviolta 150 000–270 000 ihmistä eli noin 8–9 % väestöstä. Pelissä ruokavarasto toimii puskurina huonoja vuosia vastaan, ja pitkittynyt vaje nostaa kuolleisuutta kaikissa ikäryhmissä." },
  },
  {
    id: "oppivelvollisuus_lukutaito", kategoria: "koulutus", aikakausiehto: 0, prioriteetti: "korkea", kontekstuaalinen: true,
    otsikko: { fi: "Oppivelvollisuus ja lukutaito" },
    sisalto: { fi: "Yleinen oppivelvollisuus on historiallisesti nuori keksintö — Suomessa se säädettiin vasta 1921, vaikka lukutaitoa vaadittiin jo 1600-luvulta lähtien esimerkiksi rippikoulun ehtona. Koulutuskattavuuden kasvu 1800–1900-luvuilla liittyi kiinteästi teollistumiseen: tehtaat tarvitsivat lukutaitoista työvoimaa. Pelissä koulutuskattavuus riippuu opettajien määrästä suhteessa lapsiin, ja se vaikuttaa suoraan siihen, moniko varttuvista nuorista saa kunnollisen koulutuksen." },
  },
  // Viikko 2 to 23.7.: 8 laatikkoa, kontekstuaalinen: false (vain paneelissa)
  {
    id: "ammattien_rakennemuutos", kategoria: "talous", aikakausiehto: 0, prioriteetti: "normaali", kontekstuaalinen: false,
    otsikko: { fi: "Ammattien rakennemuutos" },
    sisalto: { fi: "Rakennemuutos tarkoittaa työvoiman siirtymistä sektorista toiseen talouden kehittyessä — ensin maataloudesta teollisuuteen, sitten teollisuudesta palveluihin. Ennen teollistumista 80–90 % maailman väestöstä työskenteli maataloudessa; nykyään rikkaissa maissa osuus on alle 2 %. Pelissä tämä näkyy suoraan: kun maatalouden tuottavuus nousee aikakausittain, yhä pienempi osuus työvoimasta riittää ruokkimaan koko yhteiskunnan, ja loput vapautuvat muihin sektoreihin." },
  },
  {
    id: "saastuminen_teollistuminen", kategoria: "ymparisto", aikakausiehto: 2, prioriteetti: "normaali", kontekstuaalinen: false,
    otsikko: { fi: "Saastuminen ja teollistuminen" },
    sisalto: { fi: "Suurkaupunkien ilmansaasteet muuttuivat vakavaksi kansanterveysongelmaksi teollistumisen myötä — esimerkiksi Lontoon \"Great Smog\" vuonna 1952 tappoi noin 4 000 ihmistä muutamassa päivässä ja johti Britannian ensimmäiseen ilmansuojelulakiin (Clean Air Act, 1956). Pelissä saasteindeksi nousee teollisuuteen panostettaessa ja laskee tutkimuksen myötä." },
  },
  {
    id: "uusiutuva_energia_ilmasto", kategoria: "ymparisto", aikakausiehto: 4, prioriteetti: "normaali", kontekstuaalinen: false,
    otsikko: { fi: "Uusiutuva energia ja ilmastonmuutos" },
    sisalto: { fi: "Ilmastonmuutos eli maapallon keskilämpötilan nousu ihmisen aiheuttamien kasvihuonekaasupäästöjen vuoksi tunnistettiin tieteellisesti jo 1800-luvun lopulla (Svante Arrhenius, 1896), mutta poliittiseksi kysymykseksi se nousi vasta 1900-luvun lopulla. Pelin moderni aikakausi mahdollistaa uusiutuvan energian ja puhtaamman teknologian, jotka pienentävät saasteindeksiä samalla kun tuotanto jatkaa kasvuaan." },
  },
  {
    id: "tiedeseurat_yliopistot", kategoria: "koulutus", aikakausiehto: 0, prioriteetti: "normaali", kontekstuaalinen: false,
    otsikko: { fi: "Tiedeseurat ja yliopistot" },
    sisalto: { fi: "Järjestäytynyt tiedeyhteisö syntyi vähitellen: ensimmäiset yliopistot (esim. Bologna, 1088) opettivat aluksi lähinnä teologiaa ja lakia, kun taas kokeellinen luonnontiede järjestäytyi omiksi seuroikseen vasta 1600-luvulla (esim. Royal Society, Lontoo 1660). Pelissä tutkimuspisteiden kertyminen nopeutuu koulutuskattavuuden ja hallinnon tehokkuuden myötä — samalla tavalla kuin oikeassa historiassa tiedeinstituutiot vaativat sekä koulutettua väkeä että vakaata rahoitusta." },
  },
  {
    id: "patentit_innovaatio", kategoria: "koulutus", aikakausiehto: 1, prioriteetti: "normaali", kontekstuaalinen: false,
    otsikko: { fi: "Patentit ja innovaatio" },
    sisalto: { fi: "Patenttijärjestelmä — keksijän väliaikainen yksinoikeus keksintöönsä vastineeksi sen julkistamisesta — vakiintui Euroopassa 1400–1800-luvuilla ja nopeutti teknologian leviämistä, koska keksintöjä ei enää tarvinnut pitää salassa. Pelin keksintöjärjestelmä (esim. höyrykone, penisilliini, internet) kuvaa samaa ilmiötä yksinkertaistettuna: tutkimus tuo mukanaan konkreettisia, aikakaudelle ominaisia läpimurtoja." },
  },
  {
    id: "aikakaudet_eri_tahtiin", kategoria: "historia", aikakausiehto: 0, prioriteetti: "normaali", kontekstuaalinen: false,
    otsikko: { fi: "Miksi aikakaudet vaihtuvat eri tahtiin eri sivilisaatioilla" },
    sisalto: { fi: "Aikakausi ei vaihdu pelissä minään tiettynä kalenterivuotena, vaan silloin kun yhteiskuntasi tutkimus ja väestö riittävät — täsmälleen kuten oikeassa historiassa eri alueet teollistuivat ja modernisoituivat hyvin eri tahtiin (Englanti 1800-luvun alussa, moni muu alue vasta 1900-luvulla tai myöhemmin). Siksi kaksi samaa sivilisaatiota pelaavaa oppilasta voi päätyä hyvin erilaisiin aikakausiin samalla vuosiluvulla." },
  },
  {
    id: "kirjoitustaito_historiankirjoitus", kategoria: "historia", aikakausiehto: 0, prioriteetti: "normaali", kontekstuaalinen: false,
    otsikko: { fi: "Kirjoitustaito ja historiankirjoitus" },
    sisalto: { fi: "Kirjoitustaito syntyi itsenäisesti muutamassa paikassa maailmaa: ensin Mesopotamiassa (n. 3400–3300 eaa.) ja Egyptissä (n. 3200 eaa.), paljon myöhemmin ja toisistaan riippumatta myös Kiinassa (n. 1300 eaa.) ja Mesoamerikassa (n. 900–600 eaa.) — yli tuhat vuotta jälkimmäisten jälkeen. Varhaisin kirjoitus palveli lähinnä varastojen ja verojen kirjanpitoa. Vasta kirjoitustaidon myötä yhteiskunnista jäi omaa, ajankohtaista kirjallista lähdeaineistoa — sitä edeltävää aikaa kutsutaan esihistoriaksi, koska siitä tiedetään vain arkeologian kautta. Pelin Muinaisaika-kauden ensimmäinen keksintö on juuri kirjoitus." },
  },
  {
    id: "kolumbuksen_vaihto", kategoria: "historia", aikakausiehto: 1, prioriteetti: "normaali", kontekstuaalinen: false,
    otsikko: { fi: "Kolumbuksen vaihto" },
    sisalto: { fi: "Kolumbuksen vaihdolla tarkoitetaan kasvien, eläinten ja tautien massiivista siirtymistä Euroopan ja Amerikan välillä vuoden 1492 jälkeen. Peruna ja maissi levisivät Amerikasta Euraasiaan ja mullistivat ruokahuoltoa monin paikoin — peruna esimerkiksi mahdollisti aiempaa suuremman väestöntiheyden karummillakin mailla. Pelin Keskiaika-kauden kuvausteksti viittaa juuri tähän ilmiöön." },
  },
];

var TIETOLAATIKKO_KATEGORIAT = [
  { avain: "vaesto", nimi: { fi: "Väestö & terveys" }, ikoni: "🫀" },
  { avain: "talous", nimi: { fi: "Talous & työ" }, ikoni: "💰" },
  { avain: "yhteiskunta", nimi: { fi: "Yhteiskunta & hallinto" }, ikoni: "⚖️" },
  { avain: "ymparisto", nimi: { fi: "Ympäristö" }, ikoni: "🏭" },
  { avain: "koulutus", nimi: { fi: "Koulutus & tiede" }, ikoni: "📚" },
  { avain: "historia", nimi: { fi: "Historia & aikakaudet" }, ikoni: "⏳" },
];

// Hakufunktio: palauttaa kielikohtaisen kentän, fallback fi:hin jos kieltä ei löydy (sama malli kuin T()/TE() koodissa)
function tietolaatikkoKentta(id, kentta, lang) {
  var item = TIETOLAATIKOT.find(function (t) { return t.id === id; });
  if (!item) return "";
  var arvo = item[kentta];
  if (!arvo) return "";
  return arvo[lang] !== undefined ? arvo[lang] : arvo.fi;
}

if (typeof module !== "undefined" && module.exports) {
  module.exports = { TIETOLAATIKOT: TIETOLAATIKOT, TIETOLAATIKKO_KATEGORIAT: TIETOLAATIKKO_KATEGORIAT, tietolaatikkoKentta: tietolaatikkoKentta };
}
